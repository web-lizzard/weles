...
| S-06 | The daemon runs on Postgres and its state survives a restart | db-adapter-runtime-switch | done |
...
- **S-03: Capture persists in Postgres and commits atomically with its envelopes** — Archived 2026-09-13 → `context/archive/changes/2026-09-13-db-adapter-capture/`. Lesson: —.
- **S-04: Distill persists in Postgres and a capture approval becomes cards through the outbox** — Archived 2026-09-13 → `context/archive/changes/2026-09-13-db-adapter-distill/`. Lesson: —.
- **S-05: Remember persists in Postgres and a card rejection discards the distill card through the outbox** — Archived 2026-09-13 → `context/archive/changes/2026-09-13-db-adapter-remember/`. Lesson: —.
- **S-06: The daemon runs on Postgres and its state survives a restart** — Archived 2026-09-13 → `context/archive/changes/2026-09-13-db-adapter-runtime-switch/`. Lesson: —.
