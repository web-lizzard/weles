...
| S-05 | Users can jump from a card to the passage it came from | distill-flow-card-anchor-jump | done |
...
- **S-05: Users can jump from a card to the passage it came from** — Archived 2026-09-09 → `context/archive/changes/2026-09-08-distill-flow-card-anchor-jump/`. Lesson: —.
