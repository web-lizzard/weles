...
- [x] 1.1 Compose cloudflared is pinned, profiled, exec-healthchecked, portless, and fixed on edge — 45b23f0
- [x] 1.2 Compose api joins default and edge, and cloudflared's env file is optional — 45b23f0
- [x] 1.3 Shellcheck reports no findings on remote-deploy.sh — 45b23f0
- [x] 1.4 remote-deploy.sh waits on api alone and starts cloudflared only with its env file — 45b23f0
- [x] 1.5 Repository contains no tunnel identifier or token value — 45b23f0
- [x] 1.6 README has a Public address subsection naming no instance — 45b23f0
